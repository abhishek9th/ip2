export const siteConfig = {
  announcement: "FOR SERIOUS REAL ESTATE AGENTS WITH HIGH ENQUIRY VOLUMES…",

  hero: {
    headline: "Why ",
    headlineHighlight1: "Top 1% Real Estate Agents",
    headlineMiddle: " Never ",
    headlineHighlight2: "\"Chase Leads\"",
    subheadline:
      "They fix follow-ups first using AI to manage 500+ enquiries without hiring staff or running their business on WhatsApp",
    mentor: {
      name: "Paras Arora",
    ...
    masterclass: {
      date: "25th–26th Mar '26",
      time: "8:30 PM IST",
      duration: "90 Minutes",
      language: "Hinglish",
    },
    cta: "YES REGISTER ME FOR FREE",
  },
  ...
  ctaStrip: {
    headline: "Ready To Transform Your Career In The Next 4 Months?",
  ...
  whoItsFor: {
    ...
    thisIs: {
      ...
      items: [
        ...
        "An exclusive masterclass designed specifically for real estate agents",
      ],
    },
  },
  ...
  testimonials: {
    ...
    items: [
      {
        quote:
          "I was skeptical about AI before this session. I assumed it would be complicated or too technical. But the explanation was simple and practical. It felt like learning how a smart assistant can handle repetitive follow-ups so I can focus on actual conversations and site visits. That mindset shift alone made the session valuable.",
        name: "Pooja Mehta",
        location: "Mumbai",
      ...
      {
        quote:
          "I am running a small team, still used to miss follow-ups. This masterclass helped me see why manual systems break as enquiry numbers increase. The biggest takeaway for me was clarity I finally understood why my business felt busy but unstable, and what kind of system would bring predictability.",
        name: "Sanjay Rao",
        location: "Bangalore",
      ...
      {
        quote:
          "I always thought my ads were the problem. This session helped me see that leads were coming in, but my follow-up was inconsistent. The way the system breakdown was shown made me realise exactly where I was losing buyers.",
        name: "Rahul Mehta",
        location: "Dubai",
      ...
      {
        quote:
          "Before attending this session, I genuinely believed my main issue was lead quality. I was already spending on portals and ads, but conversions were unpredictable. This masterclass made me step back and look at what happens after the enquiry. I could clearly see how delays, missed follow-ups, and manual handling were costing me serious buyers. The way AI was explained as a support system not tech made everything click for me.",
        name: "Aman Bansal",
        location: "Gurgaon",
      ...
      {
        quote:
          "I've attended many real estate webinars before, but most of them focus on motivation or lead generation tactics. This one was very different. It calmly broke down why enquiries go silent even when interest is high. I realised my entire system depended on my availability, which was never consistent. The session didn't sell dreams it gave clarity.",
        name: "Vinod Patel",
        location: "Ahmedabad",
      ...
      {
        quote:
          "As someone managing multiple agents, follow-ups was a big problem. Everyone was busy, but deals still slipped. This session helped me understand that chaos increases when systems are missing. The AI workflow walkthrough showed me what a structured backend actually looks like and why it's necessary when enquiry volume grows.",
        name: "Arjun Malhotra",
        location: "Singapore",
  ...
  notFor: {
    ...
    footer:
      "Join this masterclass only if you're looking for clarity, control, and a real AI-powered system for your real estate business.",
  },

  bonuses: {
    title: "By the end of this masterclass, you'll have absolute clarity on:",
    cards: [
    ...
    items: [
      {
        ...
        answer:
          "Not at all. This session is built for real estate agents, not tech professionals. Everything is explained in simple, practical language.",
      },
      {
        question: "Is this about learning tools like ChatGPT or software setup?",
        answer:
          "No. This is not a tools class. You'll see how AI-led systems work at a high level, without any setup, coding, or software training.",
      },
      {
        question: "Who should attend this session?",
        answer:
          "Active real estate agents, brokers, and agencies who already receive enquiries but lose deals due to delayed or inconsistent follow-ups.",
      },
      {
        question: "I already use a CRM. Will this still be useful?",
        answer:
          "Yes. Most CRMs fail because they rely on manual updates and human discipline. This session shows what a system should do automatically, regardless of the CRM you use.",
      },
      {
        question: "Will this work for my city or local market?",
        answer:
          "Yes. The principles apply across residential and commercial real estate, regardless of city or project type.",
      },
    ],
  },
  ...
  finalCta: {
    ...
    subheadline: "Join Hundreds Of Engineers Building Their Path To Top Tech Companies.",
